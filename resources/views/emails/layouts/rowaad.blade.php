...
<head>
    ...
    {{-- Import brand fonts (fall back to system) --}}
    ...
    <style>
        /* ═══════════════ ROWAAD BRAND EMAIL — mobile-first ═══════════════ */
        body {
            margin: 0;
            padding: 0;
            background: #F0F4FA;
        ...
        .wrap {
            width: 100%;
            padding: 32px 16px;
            background: linear-gradient(180deg, #F0F4FA 0%, #E5F1F2 100%);
        }
        .card {
            max-width: 620px;
            margin: 0 auto;
            ...
            border-radius: 20px;
            overflow: hidden;
            box-shadow: 0 12px 40px -8px rgba(45, 75, 126, 0.15);
        }

        /* Header — navy gradient with brand */
        .header {
            padding: 36px 40px 32px;
            background: linear-gradient(135deg, #0A1729 0%, #122440 55%, #1A2F50 100%);
            text-align: center;
            position: relative;
        }
        .header-bar {
            height: 4px;
            background: linear-gradient(90deg, #2D4B7E 0%, #3DAFB9 50%, #6BC8D2 100%);
        }
        .brand-name {
        ...
        .eyebrow {
            ...
            border: 1px solid rgba(61, 175, 185, 0.30);
            border-radius: 999px;
            color: #3DAFB9;
            font-size: 11px;
            font-weight: 800;
        ...
        .panel {
            margin: 20px 0;
            padding: 20px 22px;
            background: linear-gradient(135deg, rgba(61, 175, 185, 0.06), rgba(45, 75, 126, 0.04));
        ...
        .btn {
            ...
            border-radius: 999px;
            box-shadow: 0 10px 24px -8px rgba(61, 175, 185, 0.55);
            letter-spacing: -0.005em;
        }
        .btn-secondary {
            background: transparent;
            color: #3DAFB9 !important;
            border: 1.5px solid #3DAFB9;
            box-shadow: none;
        }

        /* Highlight box (credentials / meeting link) */
        .highlight {
            margin: 20px 0;
            padding: 18px 22px;
            background: linear-gradient(135deg, #0A1729 0%, #1A2F50 100%);
            border-radius: 14px;
            color: #FFFFFF;
        }
        .highlight-label {
        ...
        .highlight code {
            display: inline-block;
            padding: 4px 10px;
            background: rgba(107, 200, 210, 0.15);
            border: 1px solid rgba(107, 200, 210, 0.3);
            border-radius: 8px;
