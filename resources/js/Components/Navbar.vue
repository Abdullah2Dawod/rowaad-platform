    ...
    >
        ...
        >
            ...
            <div class="flex items-center gap-1.5 shrink-0">
                ...
                <!-- Cart icon — next to language, visible only for logged-in users -->
                <a v-if="authUser" href="/cart"
                   class="relative flex items-center justify-center w-9 h-9 rounded-full text-ink-body hover:text-[#3DAFB9] hover:bg-[#3DAFB9]/10 transition-all shrink-0"
                   title="سلة المشتريات">
                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 00-16.536-1.84M7.5 14.25L5.106 5.272M6 20.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm12.75 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0z"/>
                    </svg>
                    <span v-if="cartCount > 0"
                          class="absolute top-0.5 left-0.5 rtl:left-auto rtl:right-0.5 min-w-[15px] h-[15px] px-1 rounded-full bg-gradient-to-br from-[#EF4444] to-[#DC2626] text-white text-[9px] font-black flex items-center justify-center shadow-md leading-none">
                ...
                <!-- Logged in — profile dropdown (restored original) -->
